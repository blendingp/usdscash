...
<body class="body2">
			...
			<div class="asset_block">
				<div class="assetbox">
					...
					<div class="form-block-4 w-form">
						<form id="listForm" name="listForm" action="//user/tradeHistory.do" class="form-3">
					...
					<div class="table_warp">
						<div class="asset_tabletop">
							...
							<div class="listtext1"><spring:message code="th.position"/></div>
							...
							<c:forEach var="item" items="${list}">
								...
								<div class="asset_tablelist">
									...
									<c:if test="${item.isOpen ne true}">
                                       	<c:if test="${item.position eq 'long'}"><c:set var="position" value="short"/></c:if>
                                       	<c:if test="${item.position eq 'short'}"><c:set var="position" value="long"/></c:if>
									</c:if>
									<div class="listtext1 ${position}">
										${fn:toUpperCase(position)}
									</div>
		...
		<div class="settle-complete" id="settlePop" style="display: none; z-index: 15; letter-spacing: -0.5px; font-family:'Nanumsquareotf ac', sans-serif;">
			<div class="settle-complete__box">
				<div class="div-block-84">
					...
					<img src="//webflow/images2/sub_logo1.svg" loading="lazy" alt="" class="image-68">
				</div>
				...
				<a href="#" onclick="$('#settlePop').css('display','none');"
					...
					src="//webflow/images2/wx.png" loading="lazy" sizes="100vw"
					alt="" class="popximg"></a>
			</div>
		</div>
	</div>
	...
	<script src="//webflow/js/webflow2.js" type="text/javascript"></script>
