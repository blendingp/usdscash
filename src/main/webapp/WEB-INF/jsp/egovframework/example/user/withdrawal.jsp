	...
	<div class="all">
		...
		<div class="body3">
			<div class="refer1">
				<div class="refermenu">
					<div class="rewardmtitle">
						<img src="/usdscash/webflow/louisImage/Person_icon.png" loading="lazy" alt="" class="rewardmenuicon">
						<div class="rewardmlisttext"><spring:message code="wallet.spotWallet"/></div>
					</div>
					<div class="rewardmlist" onclick="location.href='/usdscash/user/wallet.do'" style="cursor: pointer;">
						<div class="rewardmlisttext"><spring:message code="wallet.deposit"/></div>
					</div>
					<div class="rewardmlist click" onclick="location.href='/usdscash/user/withdrawal.do'" style="cursor: pointer;">
						<div class="rewardmlisttext"><spring:message code="wallet.withdrawal"/></div>
					</div>
					<div class="rewardmtitle">
						<img src="/usdscash/webflow/louisImage/Exchange_icon.png" loading="lazy" alt="" class="rewardmenuicon">
						<div class="rewardmlisttext"><spring:message code="wallet.spotExchange"/></div>
					</div>
					<div class="rewardmlist" onclick="location.href='/usdscash/user/exchange.do'" style="cursor: pointer;">
						<div class="rewardmlisttext">BTC</div>
						<img src="/usdscash/webflow/louisImage/arrow_icon.png" loading="lazy" alt="" class="image-9">
						<div class="rewardmlisttext">USDT</div>
					</div>
					<div class="rewardmtitle">
						<img src="/usdscash/webflow/louisImage/Transfer_icon.png" loading="lazy" alt="" class="rewardmenuicon">
						<div class="rewardmlisttext"><spring:message code="wallet.transfer"/></div>
					</div>
					<div class="rewardmlist" onclick="location.href='/usdscash/user/transfer.do'" style="cursor: pointer;">
			...
			<div class="refer2">
				<div class="notiin1-copy">
					<div class="momenutitle">
						...
						<a href="#" onclick="$('.notimenu').slideToggle();$('.momeup , .momedown ').toggle()" class="momelink w-inline-block">
							<img src="/usdscash/webflow/louisImage/check.png" loading="lazy" sizes="100vw" srcset="/usdscash/webflow/louisImage/check-p-500.png 500w, /usdscash/webflow/louisImage/check-p-800.png 800w, /usdscash/webflow/louisImage/check.png 1200w" alt="" class="momedown">
							<img src="/usdscash/webflow/louisImage/check_1.png" loading="lazy" sizes="(max-width: 767px) 15px, 100vw" srcset="/usdscash/webflow/louisImage/check_1-p-500.png 500w, /usdscash/webflow/louisImage/check_1-p-800.png 800w, /usdscash/webflow/louisImage/check_1.png 1200w" alt="" class="momeup">
						</a>
					</div>
					<div class="notimenu">
						<div class="rewardmlist-copy">
							<div class="rewardmlisttext"><spring:message code="wallet.spotWallet"/></div>
							<img src="/usdscash/webflow/louisImage/right_icon.png" loading="lazy" alt="" class="cusarrow">
						</div>
						<div class="rewardmlist"
							onclick="location.href='/usdscash/user/wallet.do'">
							<div class="rewardmlisttext"><spring:message code="wallet.deposit"/></div>
							<img src="/usdscash/webflow/louisImage/right_icon.png" loading="lazy" alt="" class="cusarrow">
						</div>
						<div class="rewardmlist click"
							onclick="location.href='/usdscash/user/withdrawal.do'">
							<div class="rewardmlisttext"><spring:message code="wallet.withdrawal"/></div>
							<img src="/usdscash/webflow/louisImage/right_icon.png" loading="lazy" alt="" class="cusarrow">
						</div>
						<div class="rewardmlist-copy">
						...
						<div class="rewardmlist" onclick="location.href='/usdscash/user/exchange.do'">
							<div class="rewardmlisttext">BTC ↔ USDT</div>
							<img src="/usdscash/webflow/louisImage/right_icon.png" loading="lazy" alt="" class="cusarrow">
						</div>
						<div class="rewardmlist" onclick="location.href='/usdscash/user/transfer.do'">
				...
				<div class="walletbox">
					<div class="wcoin">
						<img src="/usdscash/webflow/louisImage/BTC_icon_1.png" loading="lazy"
							alt="" class="wcoinimg">
					...
					<div class="wcoin">
						<img src="/usdscash/webflow/louisImage/USDT_icon.png" loading="lazy"
							alt="" class="wcoinimg">
...
/* 			$.ajax({
				...
				success : function(dat) { */
					...
					var url = "/usdscash/user/updateWalletBalance.do";
 					$.ajax({
						type : 'post',
						url : url,
						data : usdtData,
					...
					$.ajax({
						type : 'post',
						url : "/usdscash/user/transaction.do",
						data : trsData,
						success : function(data) {
							if (data.result == 'success') {
				...
				success : function(data) { */
					...
					$.ajax({
						...
						success : function(data) {
							if (data.result == 'success') {
								alert('송금이 완료되었습니다.');
								location.href = "/usdscash/user/wallet.do";
							} else if (data.result == 'fail') {
								console.log(data);
								alert('오류가 발생했습니다. 다시 시도해주세요.');
							}
