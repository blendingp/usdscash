...
<%-- 								<a href="javascript:setAuth('settelegram')" class="button-65 w-button settelegrambtn"><spring:message code="affiliate.cb.3"/> <spring:message code="join.request"/></a> --%>
							...
							<input type="password"	class="text-field-10 w-input" name="pw" id="pw" placeholder="<spring:message code="join.pWrong"/>" onkeypress="if(event.keyCode==13) {javascript:login(); return false;}">								<input type="submit" value="<spring:message code="menu.login" />" data-wait="Please wait..." class="submit-button-2 w-button">
						</form>
						...
						<div class="login_pwtxt">
                			<div onclick="location.href='/usdscash/join.do'" class="login_pwbtn" style="cursor:pointer;"><spring:message code="menu.register2"/></div>
              			</div>
					</div>
				</div>
			</div>
