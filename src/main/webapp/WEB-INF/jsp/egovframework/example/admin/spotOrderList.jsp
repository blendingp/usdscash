		...
		<div id="content-wrapper">
			<div id="content">
				...
				<div class="container-fluid">
					<h1 class="h3 mb-2 text-gray-800">${username}주문내역</h1>
					<div class="row">
						<div class="col-lg-12">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form
										action="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/spottrade/orderList.do"
												...
												<div class="form-group input-group">
													<span class="input-group-btn">
														<button class="btn btn-info btn-sm"
															onclick="setOrder('orderDatetime')" type="button">시간</button>
													</span>
												</div>
											</div>
											<div class="col-lg-1">
											...
											<tbody>
												<c:forEach var="item" items="${list}" varStatus="i">
													<tr style="background-color:${item.color}">
														...
														<td><c:if test="${item.position eq 'long'}">Long</c:if>
															<c:if test="${item.position eq 'short'}">Short</c:if></td>
