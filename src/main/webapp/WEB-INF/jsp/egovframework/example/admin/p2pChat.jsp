		                                    ...
		                                    <tbody>
		                                        <tr style="background-color:${data.color}">
		                                            ...
		                                            <c:if test="${data.istest eq '1'}">
		                                            	<td onclick="location.href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${data.useridx}'" style="cursor:pointer;">${data.userName} <span style="color:red">(테스트 계정)</span></td>
		                                            </c:if>
		                                            <c:if test="${data.istest ne '1'}">
		                                            	<td onclick="location.href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${data.useridx}'" style="cursor:pointer;">${data.userName}</td>
		                                            </c:if>
		                                            <td>${data.mbank}</td>
		                                            <td>${data.maccount}</td>
...
function send(pidx,midx){
	...
	jQuery.ajax({                                
        type:"POST", 
        url : "/usdscash/0nI0lMy6jAzAFRVe0DqLOw/p2p/chatSend.do",
        dataType:"json",
...
function deleteChat(pidx,midx){
	...
	jQuery.ajax({                                
        type:"POST", 
        url : "/usdscash/0nI0lMy6jAzAFRVe0DqLOw/p2p/deleteChat.do",
        dataType:"json",
