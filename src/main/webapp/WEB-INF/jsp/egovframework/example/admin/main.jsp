...
function getMoneySum(sdate, edate) {
	$.ajax({
		...
		url : '/usdscash/0nI0lMy6jAzAFRVe0DqLOw/getDashboard.do',
		dataType : "json",
		success : function(data) {
			...
			$("#userDeposit").html("<td>유저 입금 총액</td>"
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=%2B&coin=BTC&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw btc'>"
									...
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=%2B&coin=ETH&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw eth'>"
									...
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=%2B&coin=USDT&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw usdt'>"
									...
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=%2B&coin=XRP&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw xrp'>"
									...
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=%2B&coin=TRX&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw trx'>"
			...
			$("#withdraw").html("<td>출금 총액</td> "
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=-&coin=BTC&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw btc'>"
									+ witharray[0]
									+ "</a><span class='krwCoin'> BTC</span></td> "
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=-&coin=ETH&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw eth'>"
									+ witharray[4]
									+ "</a><span class='krwCoin'> ETH</span></td> "
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=-&coin=USDT&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw usdt'>"
									+ witharray[1]
									+ "</a><span class='krwCoin'> USDT</span></td> "
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=-&coin=XRP&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw xrp'>"
									+ witharray[2]
									+ "</a><span class='krwCoin'> XRP</span></td> "
									+ "<td><a href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/transactions.do?label=-&coin=TRX&wstat=1&test=test&sdate="
									+ sdate
									+ "&edate="
									+ edate
									+ "' class='onkrw trx'>"
