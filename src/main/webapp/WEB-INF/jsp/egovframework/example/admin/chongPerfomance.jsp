					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form action="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/chongPerfomance.do" name="listForm" id="listForm">
										<div class="row">
											...
											<tbody>
												<c:forEach var="item" items="${list}" varStatus="i">
													<tr
														...
														<td
															onclick="location.href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${item.idx}'"
