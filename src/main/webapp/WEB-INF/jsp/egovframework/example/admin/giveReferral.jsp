			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="col-lg-12">
						...
						<div class="card-body">
							<form action="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/referral/giveReferral.do"
									...
									<tbody>
										...
										<c:forEach var="item" items="${list}" varStatus="i">
											<tr style="background-color:${item.color}">
												<td
													onclick="location.href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${item.uidx}'"
												...
												<td><button class="btn-xs btn-default"
														onclick="location.href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/referral/accumTradeLog.do?uidx=${item.uidx}&username=${item.name}'">내역
														보기</button></td>
	...
	if(confirm("지급하시겠습니까?")){
		$.ajax({
			...
			success:function(data){
				alert(data.msg);
				if(data.result == "suc"){
					location.href="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/referral/giveReferral.do";
				}
			},
			error:function(e){
