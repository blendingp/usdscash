...
<body>
	<div id="wrapper">
        ...
        <div id="page-wrapper">
		   ...
		   <form action="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/apply/promotionList.do" name="listForm" id="listForm">
...
<script>
	function changeApproval(idx , approval){
		$.ajax({
			type:'get',
			url:'/usdscash/0nI0lMy6jAzAFRVe0DqLOw/apply/promotionApproval.do?idx='+idx+'&approval='+approval,
