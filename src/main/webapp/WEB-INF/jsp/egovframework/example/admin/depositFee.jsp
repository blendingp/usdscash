       ...
       <div id="content-wrapper">        	
			...
			<jsp:include page="../adminFrame/top.jsp"></jsp:include>	           
	            <div class="container-fluid">
                	<h1 class="h3 mb-2 text-gray-800">${coinname} 입금 수수료 변경</h1>
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form action="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/account/updateDepositFee.do" name="updateForm" id="updateForm" method="post">
