			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<!-- /.panel-heading -->
							<form action="/usdscash/0nI0lMy6jAzAFRVe0DqLOw/log/log.do"
											...
											<tr>
												...
												<td><c:if test="${item.name ne null}">
														<span style="cursor: pointer;"
															onclick="location.href='/usdscash/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${item.uidx}'">${item.name}
															(등급 : ${item.level})</span>
													</c:if></td>
