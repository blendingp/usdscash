...
function showPopup(msg, level) { // msg:팝업 메세지 , level: 1-완료 2-미완료 3-아이콘 없음
	...
	let image = "";
	if (level == 1) {
		image = "<img src=\"/usdscash/webflow/images/check.png\" loading=\"lazy\" class=\"image-39\">";
	} else if (level == 2) {
		image = "<img src=\"/usdscash/webflow/images/error.png\" loading=\"lazy\" class=\"image-39\">";
	}
...
function appendLiqPop(obj){
	...
	var text = "<div class='settle-complete' id='settlePop' style='display:flex; z-index:15; "+back+"'> <div class='settle-complete__box'> <div class='div-block-84'> <div class='pop_yieldtxt " +
		...
		yieldtext+"</span> </div> <img src='/usdscash/webflow/images/sub_logo1.svg' sizes='100vw' class='image-68'> </div> <div class='div-block-124'> <div class='div-block-85'> <div class='qet'>" +
		...
		fmtNum(liq)+"<span class='wr'> USDT</span> </div> </div> </div> <a href='#' onclick='$(this).parent().parent().remove();' class='popx w-inline-block'><img src='images/wx.png' loading='lazy' srcset='/usdscash/webflow/images/wx.png' sizes='100vw' class='popximg'></a> </div> </div>";
